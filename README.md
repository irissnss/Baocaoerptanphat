...
| M5 | Kho Hàng | 🔨 In Dev | NCC, mua hàng, nhập/xuất kho, giao hàng, kiểm kê, kho thành phẩm — CRUD đầy đủ + RBAC + realtime.<br>**Tồn kho — đã tự động (đo 24/08/2026):** giao hàng tự trừ tồn thành phẩm và tự hoàn khi huỷ · phiếu nhập và phiếu xuất vật tư tự ghi **sổ kho**, chống ghi hai lần, **chặn xuất vượt tồn**, huỷ phiếu thì tự sinh bút toán đảo.<br>**Còn thủ công:** *kiểm kê* mới ghi nhận chênh lệch và số phiếu điều chỉnh, **chưa tự** ghi sổ kho — phải lập phiếu điều chỉnh riêng · *mua hàng* **chưa** tự sinh công nợ. | 10 sub-routes |
...
>
> ✅ **ĐÃ PHÁT HÀNH V1.00.353 + V1.00.354 lên hệ thống vận hành (23/08/2026).** Hệ thống vận hành nay chạy **V1.00.354** (mã `<mã-nguồn-riêng>`), trước đó là V1.00.352. **V1.00.353** — go-live chuỗi bán hàng 4 đợt: nạp ma trận phân quyền · vá **6 lỗ hổng chặn go-live** · hoàn thiện đơn hàng (ngày giao · địa chỉ giao lấy đúng danh bạ khách · công nợ thôi tính đơn nháp) · thêm **ma trận tick quyền hành động**. **V1.00.354** — **quyền sửa biểu mẫu nay chỉ quản trị và tổng giám đốc**, cấp bằng **ô tick** chứ không viết cứng vai trò trong mã: đổi người giữ quyền chỉ cần bỏ tick/tick lại, không phải sửa mã và phát hành lại. Trước đó ai có quyền nhóm Hệ Thống là sửa được mẫu in — mà nhóm đó còn chứa cả phân quyền. **Số đo:** 16 bộ kiểm thử · **675 điểm kiểm · 0 trượt** · **0 thay đổi cấu trúc dữ liệu** (101 bảng trước = 101 bảng sau) · diễn tập trên bản sao dữ liệu vận hành lấy mới · **kiểm khói sau phát hành 12/12 đạt, 0 lỗi máy chủ**. Dữ liệu thử: đã dọn sạch cả hai nơi; bản sao dùng diễn tập đã xoá. Chi tiết: [PHAT-HANH-V1.00.353-VA-354-20260823.md](PHAT-HANH-V1.00.353-VA-354-20260823.md).
>
> 🔒 **QUẢN TRỊ — Pha B + Pha C (23–24/08/2026). 0 dòng mã nghiệp vụ bị đụng, phiên bản KHÔNG tăng.** Chuỗi báo cáo đọc theo thứ tự: **chẩn đoán** → [LUAT-SKILL-UI-GOP-20260823.md](LUAT-SKILL-UI-GOP-20260823.md) → [**PHA B**](PHA-B-HOAN-TAT-20260823.md) → [**PHA C**](PHA-C-DONG-SO-CONTEXT7-TRIGGER-CHONG-TRUNG-MA-20260824.md). **Pha B** — vá gốc danh mục kỹ năng: tách **hiệu lực nội dung** khỏi **sức khoẻ cấu trúc** (một kỹ năng có thể "cấu trúc lành" mà nội dung đã ngừng dùng — trước đây một nhãn gánh hai nghĩa nên người tra đọc nhầm), gắn nhãn cho **128/128** kỹ năng và **không tự gán "còn hiệu lực"** cho cái nào; loại các **lệnh không chạy được** khỏi trường điều kiện kiểm. **Pha C** — khoá **điều kiện gọi Context7**: trước đó mục công cụ này chỉ có **4 dòng**, không có điều kiện được gọi, không có điều kiện cấm gọi, **không dòng nào cấm gửi mã nguồn riêng ra ngoài**; nay có 6 điều kiện gọi + 12 điều kiện cấm + chính sách dữ liệu + chống **chỉ dẫn lẫn trong dữ liệu** trả về, và đã **chạy thử thật một lần có kiểm soát** (chỉ gửi tên thư viện công khai, đối chiếu lại với máy → khớp, không phát sinh sửa mã). Kèm **cổng chống trùng mã** cho hai sổ (kiểm ngược 5/5) và vá một mã nợ bị cấp trùng. Chuỗi kiểm quản trị nâng lên **15 cổng**. **Pha C2** — vá xong mục sổ bị hai việc dùng chung số, **nối cổng chống trùng** vào chuỗi kiểm tự động (**16 cổng**) và hook trước mỗi lần ghi mã (**4 cổng**), đính chính mốc commit của Pha B. **Pha C3** — audit sự thật hiện hành: đồng bộ sổ số phát hành theo **ba lớp bằng chứng**, hoà giải **99 ↔ 101 bảng** (lệch thời điểm, không phải đếm sai), nêu đúng mức tự động hoá tồn kho **M5 theo từng nhánh**, phân định bốn con số **14/16/4/7**. Chi tiết: [PHA-C3-AUDIT-TRANG-THAI-HIEN-HANH-20260824.md](PHA-C3-AUDIT-TRANG-THAI-HIEN-HANH-20260824.md). **Pha C3.1 (25/08)** — ghi sổ **chín quyết định nền** của chủ dự án: Notion là **sổ gốc chuẩn** · **chính sách CSDL MariaDB 10.11 LTS cho cả hai môi trường** · **101 bảng** · **"đang chạy thật" chỉ được nói khi chính lượt đó đã đo**. Kèm **đo read-only** và sửa các kết luận **vượt quá bằng chứng** ở lượt trước. Chi tiết: [PHA-C3-1-DONG-CHUAN-NGUON-SU-THAT-20260825.md](PHA-C3-1-DONG-CHUAN-NGUON-SU-THAT-20260825.md). **Nâng luật `2.7 → 2.8` (25/08)** — chủ dự án nêu: đôi lúc **code đi trước tài liệu** vì trao đổi trực tiếp liên tục cho liền mạch; điều đó **hợp lệ**, nhưng việc **ghi nhận xác nhận/chia sẻ của chủ dự án** phải chuẩn hoá để trợ lý Notion **không bỡ ngỡ và không phản bác**. Đo được **ba khe hở** và đã vá: trường trạng thái đồng bộ **bị bắt buộc ghi mà không có bảng giá trị** · phiên nhiều chỉ thị nối nhau **không bắt mỗi chỉ thị một mục** (3/5 chỉ thị bị bỏ sót, **đã ghi bù giữ mốc thật**) · **không** bắt tạo **gói bàn giao**. **Còn mở:** hệ quản trị CSDL và phiên bản **đang chạy thật** (chưa được cấp kênh đo) · tách *bảng* với *khung nhìn* · kiểm thử vận hành thật M5 · bàn giao Notion — mỗi việc đã ghi rõ cách đóng.
>
> 🕰️ **TRẠNG THÁI TRƯỚC KHI PHÁT HÀNH — ĐÃ ĐƯỢC THAY THẾ.** Khối dưới đây ghi lúc chuỗi bán hàng **chưa** lên máy vận hành. **Nay đã phát hành:** V1.00.353 đưa trọn 4 đợt A·B·C·D lên vận hành (23/08/2026), V1.00.354 theo ngay sau. Giữ nguyên văn làm mốc lịch sử, **không** đọc như trạng thái hiện hành.
>
...
> 🕰️ **GHI TẠI 25/07/2026 — PHẦN "CHƯA TỰ ĐỘNG" ĐÃ ĐƯỢC THAY THẾ.** Khoảng trống nêu trong khối dưới đã được lấp bởi **V1.00.338** (giao hàng tự trừ tồn) và **V1.00.350** (phiếu nhập/phiếu xuất vật tư tự ghi sổ kho). Trạng thái hiện hành theo từng nhánh xem ô **M5** ở bảng trạng thái đầu tệp. Giữ nguyên văn làm mốc lịch sử.
>
...
- **Công bố snapshot governance:** thư mục [`LUAT-QUAN-TRI-20260819/`](LUAT-QUAN-TRI-20260819/) — 1 bản replica bộ luật (`CLAUDE.md`, sha256 `<mã-nguồn-riêng>`, parity **5/5 OK**), chuẩn giao diện (`UI-STANDARD.md`), registry nguồn UI, mẫu bảng nghiệm thu, và **bản CÔNG KHAI (đã che vị trí)** của trạng thái rà thông tin nhạy cảm.
...
| Database (máy vận hành) — **policy** | MariaDB | 10.11 LTS |
| Database (máy phát triển) — **policy** | MariaDB | 10.11 LTS |
| Form | React Hook Form + Zod 4 | Latest |
| UI Components | Radix UI + Shadcn | Multiple |
| Icons | Lucide React | 0.462.0 |
| Template | Metronic (Demo 1) | Licensed |

> 🗄️ **Về hệ quản trị CSDL — phân biệt *chính sách* với *đang chạy thật*.**
> **Chính sách (chủ dự án chốt 25/08/2026):** cả máy phát triển lẫn máy vận hành đều dùng **MariaDB 10.11 LTS**. Chính sách khoá **dòng** 10.11 LTS; số hiệu bản vá cụ thể ghi ở sổ kỹ thuật, **không** biến mỗi bản vá thành một chính sách mới.
> *(Bảng trên trước đây ghi máy phát triển dùng MySQL 8.4 — đó là **trạng thái trước 09/08/2026**, nay đã được chính sách 25/08 thay thế. Các khối lịch sử phía dưới **giữ nguyên**.)*
>
> **Đang chạy thật:** ⏳ **chưa đo trong lượt này.** Dịch vụ CSDL trên máy phát triển đang **tắt** ở thời điểm rà soát, và lượt rà soát **không được cấp** kênh đọc trên máy vận hành. Theo quy ước của dự án, **chỉ** được ghi *"đang chạy thật"* khi **chính lượt đó đã đo trực tiếp** — nên ở đây ghi **chưa đo**, không suy từ chính sách ra.
